...
def main():
    parser = argparse.ArgumentParser(description="MIBF ResNet prediction for HAM10000 (lib_dl)")
    parser.add_argument(
        "--image_root",
        type=str,
        default="/data/QLI/Assignment_for_dl/Data/data_for_dl/HAM10000_dataset/test",
    )
    parser.add_argument(
        "--json_path",
        type=str,
        default="/data/QLI/Assignment_for_dl/Data/data_for_dl/HAM10000_dataset/response/test/responses.json",
    )
    parser.add_argument("--model_path", type=str, required=True)
    parser.add_argument(
        "--output_path",
        type=str,
        default="/data/QLI/Assignment_for_dl/lib_dl/results/mibf_net/preds_ham.csv",
    )
